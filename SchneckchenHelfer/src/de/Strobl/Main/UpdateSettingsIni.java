	...
	public static void Update() {
		try {
			...
			while (!currentversion.equals(Main.version)) {
				...
				if (!currentversion.equals(Main.version)) {
					...
					} else if (currentversion.equals("v1.4.2") || currentversion.equals("v1.4.3")
							|| currentversion.equals("v1.4.4") || currentversion.equals("v1.4.5")
							|| currentversion.equals("v1.5.0") || currentversion.equals("v1.6.0")
							|| currentversion.equals("v1.6.1") || currentversion.equals("1.6.2")) {
						ini.put("Setup", "VersionBot", "1.6.2");
						ini.store();
						System.out.println("Updated settings.ini from Version " + currentversion + " to Version 1.6.2");
